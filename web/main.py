...
def index():
    ...
    #default values
    var_text = getitem(request.form, 'place_holder','temporary holding text')
    ...
    if request.method == 'POST':# and 'symbol' in request.form:
        ...
        try:
            print "try"
            script, div, js, css = generate_plot('title 1', 'title2', current_var1,[current_var2_0,current_var2_1])
            print "made script and div"
            html = flask.render_template('index.html', place_holder="request.method was post", plot_script=script, \
             plot_div=div, js_resources=js, css_resources=css, html_var1=current_var1, html_var2_0=current_var2_0, \
             html_var2_1=current_var2_1)
            return html
        except:
            print "in exception"
            ...
            print "in else"
            html = flask.render_template('index.html', place_holder="Method was not post", plot_script=script, \
                plot_div=div, js_resources=js, css_resources=css, html_var1=current_var1, \
                html_var2_0=current_var2_0, html_var2_1=current_var2_1)
            return html
    #else:
